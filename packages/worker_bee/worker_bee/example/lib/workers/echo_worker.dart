...
abstract class EchoWorker extends WorkerBeeBase<EchoMessage, EchoResponse> {
  ...
  Future<EchoResponse?> run(
    ...
    logger.info('Echo worker shutting down. Total messages processed: $_messageCount');
    return null;
  }
}
