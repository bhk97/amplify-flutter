...
abstract class EchoMessage implements Built<EchoMessage, EchoMessageBuilder> {
  ...
  EchoMessage._();
  factory EchoMessage([void Function(EchoMessageBuilder) updates]) = _$EchoMessage;
...
abstract class EchoResponse implements Built<EchoResponse, EchoResponseBuilder> {
  ...
  EchoResponse._();
  factory EchoResponse([void Function(EchoResponseBuilder) updates]) = _$EchoResponse;
